...
if OBSERVABLE == "inclusive":
    ...
    if "gen" in OTHER:
        GENN = "Gen_"
        FUNCTION_2L=all_vars[OBSERVABLE+"_%s"%REGION].FUNCTION_2L
        CATBINS=all_vars[OBSERVABLE+"_%s"%REGION].CATBINS_Gen

    else:
        FUNCTION_2L=all_vars[OBSERVABLE+"_%s"%REGION].FUNCTION_2Lreco
        CATBINS=all_vars[OBSERVABLE+"_%s"%REGION].CATBINS
